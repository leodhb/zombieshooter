...
var gameover = {
		...
		create: function(){
				...
				botao_voltar = game.add.button(game.world.centerX - 95, 400, 'button', voltarAoMenu, this, 2, 1, 0);
...
var jogo = {
	...
	create: function(){
		...
		timer.loop(40000, fimDeJogo, this);
		timer.start();
		wave = 1;
	...
	render: function()
	{
		var tempo = timer.duration.toFixed(2) / 1000;
		game.debug.text('Onda: ' + wave + ' | Tempo: ' + tempo, 20, 462);
	}
};
